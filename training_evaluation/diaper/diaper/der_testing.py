...
def main():
    ...
    rttm = "diaper/rttms/NeHi/Mspk_Mspk_2/rttms/*rttm"
    output_file = f"diaper/result/NeHi/Mspk_Mspk_2.txt"

    segments = "diarization_dataset/unique_speaker_dataset/merged_test/NeHi/Mspk/details/segments"
