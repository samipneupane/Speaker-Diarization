...
def parse_arguments() -> SimpleNamespace:
    ...
    #####
    import yaml
    config_path = "EEND/yaml/infer.yaml"
    ...
    args.epochs = '15-20'
    args.models_path = 'EEND/model/Mspk/models'
    args.rttms_dir = 'EEND/rttms/VoxCeleb/Mspk_Mspk'
    
    args.estimate_spk_qty = 4
    args.infer_data_dir = 'diarization_dataset/unique_speaker_dataset/merged_test/VoxCeleb/Mspk/test_details'
