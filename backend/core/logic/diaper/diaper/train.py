...
from core.logic.diaper.diaper.backend.updater import setup_optimizer, get_rate
from core.logic.diaper.diaper.common_utils.diarization_dataset import (
    KaldiDiarizationDataset,
    PrecomputedDiarizationDataset)
from core.logic.diaper.diaper.common_utils.metrics import (
    calculate_metrics,
    new_metrics,
    reset_metrics,
    update_metrics,
...
def parse_arguments() -> SimpleNamespace:
    ...
    default_config = "yaml/finetune.yaml"
    ...
    args.init_epochs = "745-750"
    args.init_model_path = "models/20attractors/SC_LibriSpeech_2spk_adapted1-10_finetuneAliMeetingFarmix/models"
    args.max_epochs = 5
    args.n_attractors = 20
    args.num_speakers = 2
    args.output_path = "models/trained_models"
    args.train_data_dir = "merged_details/combined_2spk/train_details"
    args.valid_data_dir = "merged_details/combined_2spk/valid_details"
...
if __name__ == '__main__':
    ...
    for epoch in range(int(round(init_epoch)), args.max_epochs):
        ...
        # printing every key and values of acum_dev_metrics
        print("Validation:")
        for key, value in acum_dev_metrics.items():
            print(f"{key}: {float(value)/dev_batches_qty}")
